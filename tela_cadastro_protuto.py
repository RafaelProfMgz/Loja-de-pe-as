...
class TelaCadastro_produtos(Atividades):
    ...
    def abrir(self):
        ...
        self.janela_cadastroProdutos = tkinter.Toplevel(self.janela_master)
        self.janela_cadastroProdutos.title("Compra")
        self.janela_cadastroProdutos.configure(background='#3f3e3e')
        self.janela_cadastroProdutos.geometry("1080x720")
        self.janela_cadastroProdutos.minsize(620, 500)
        self.janela_cadastroProdutos.grab_set()
    ...
    def AppComBarraDeMenu(self):
        ...
        self.relatorioProdutos = RelatorioProdutos(self.db_connection, self.cursor, self.janela_cadastroProdutos)
        
        #Cria o menu e define a janela que ele vai ficar
        barra_menu = tkinter.Menu(self.janela_cadastroProdutos)
        self.janela_cadastroProdutos.config(menu=barra_menu)
    ...
    def sair_cadastro_produtos(self):
        self.janela_cadastroProdutos.destroy()
    ...
    def criar_frame(self):
        #Frame 1
        self.frame_1 = tkinter.Frame(self.janela_cadastroProdutos, bd=2, bg='#4b4b49', highlightbackground='#c4a90d',highlightthickness=2)
